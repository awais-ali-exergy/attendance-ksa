...
import { IntlService, S3Service, UtilityService } from "../../services";
          ...
          onDrop={async (acceptedFiles) => {
            ...
            if (isInternet) {
              if (
                ...
                toast.error(
                  `Sorry, You can not upload more than ${maxFiles} images`
                );
              }
              ...
              toast.error(IntlService.m("Internet not available!"));
            }
          }}
        >
